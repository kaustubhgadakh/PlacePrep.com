...
window.onload = function () {
    ...
    if((mail.value=="kaustubhgadakh@gmail.com" && data.password=="admin")||(mail.value=="sonvanesaurabh77@gmail.com" && data.password=="admin")){
            document.getElementById("mcq").style.display="block";
            document.getElementById("sdetail").style.display="block";
            document.getElementById("prof").textContent="Admin";
    }
